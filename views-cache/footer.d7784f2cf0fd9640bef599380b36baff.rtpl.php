<?php if(!class_exists('Rain\Tpl')){exit;}?>    <div class="footer-top-area">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <?php require $this->checkTemplate("includes/categories-menu");?>
    ...
    <!-- jQuery sticky menu -->
    <script src="/e-commerce/assets/site/js/owl.carousel.min.js"></script>
    <script src="/e-commerce/assets/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/e-commerce/assets/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/e-commerce/assets/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/e-commerce/assets/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/e-commerce/assets/site/js/script.slider.js"></script>
  </body>
</html>