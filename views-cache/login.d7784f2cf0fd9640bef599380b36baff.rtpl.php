    ...
    <div class="container">
        <div class="row">                
            <div class="col-md-6">
                ...
                <form action="/e-commerce/login" id="login-form-wrap" class="login" method="post">
                    <h2>Acessar</h2>
                    ...
                    <p class="lost_password">
                        <a href="/e-commerce/forgot">Esqueceu a senha?</a>
                    </p>
            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/e-commerce/register" class="register" method="post">
                    <h2>Criar conta</h2>
                    <p class="form-row form-row-first">
