...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/e-commerce/admin/categories">Products</a></li>
    <li class="active"><a href="/e-commerce/admin/categories/create">Cadastrar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/e-commerce/admin/products/create" method="post">
          <div class="box-body">
